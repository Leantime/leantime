    ...
    class mailer
    {
        ...
        public function __construct()
        {
            ...
            if($config->useSMTP === true) {
                ...
                $this->mailAgent->SMTPAuth = $config->smtpAuth;                               // Enable SMTP authentication
                ...
                if($config->smtpSSLNoverify === true) {        //If enabled, don't verify certifcates: accept self-signed or expired certs.
