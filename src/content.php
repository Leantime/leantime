...
<head>
    ...
    <link rel="stylesheet" href="<?=BASE_URL?>/css/vars.css.php?color1=<?php echo htmlentities(str_replace("#","",$_SESSION["companysettings.primarycolor"])) ?>&color2=<?php echo htmlentities(str_replace("#","",$_SESSION["companysettings.secondarycolor"])) ?>&v=<?php echo $settings->appVersion; ?>"/>
