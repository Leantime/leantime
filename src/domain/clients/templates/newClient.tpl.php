...
<div class="pageheader">
    ...
    <div class="pageicon"><span class="fa fa-address-book"></span></div>
            <div class="pagetitle">
                ...
                <h1><?php echo $this->__('NEW_CLIENT'); ?></h1>
            </div>
        </div><!--pageheader-->
...
<form action="" method="post" class="stdform">
    ...
    <label
        for="name"><?php echo $this->__('NAME') ?></label> <input type="text"
        name="name" id="name" value="<?php echo $values['name'] ?>" /><br />
        
    <label
        for="email"><?php echo $this->__('EMAIL') ?></label> <input type="text"
    ...
    <p class="stdformbutton">
        <input type="submit" name="save" id="save" value="<?php echo $this->__('SAVE') ?>" class="btn btn-primary" /></fieldset>
        <input type="reset" class="btn btn-secondary" value="<?php echo $this->__('RESET_BUTTON') ?>" />
    </p>
