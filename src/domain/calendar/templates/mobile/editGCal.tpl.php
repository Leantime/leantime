...
<fieldset>
	...
	<input type="text" id="url" name="url" value="<?php echo $values['url']; ?>" /><br />
...
<a href="index.php?act=calendar.delGCal&amp;id=<?php echo htmlentities($_GET['id']); ?>" class="link">Kalender löschen</a>
<a href="index.php?act=calendar.showAllGCals" class="link">zurück</a>
</form>
