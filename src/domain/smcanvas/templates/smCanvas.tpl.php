        ...
        <div id="sortableCanvasKanban" class="sortableTicketList disabled">
            ...
            <div class="row-fluid">
                <div class="column" style="width:100%">
                    <h4 class="widgettitle title-primary center"><?php echo $canvasLabels["sm_a"]; ?></h4>
                    <?php $elementName = 'sm_a'; require(ROOT.'/../src/library/canvas/tpl.element.inc.php'); ?>
                </div>
            </div>

            <div class="row-fluid">
                <div class="column" style="width:100%">
                    <h4 class="widgettitle title-primary center"><?php echo $canvasLabels["sm_b"]; ?></h4>
                    <?php $elementName = 'sm_b'; require(ROOT.'/../src/library/canvas/tpl.element.inc.php'); ?>
                </div>
            </div>
				
            <div class="row-fluid">
                <div class="column" style="width:100%">
                    <h4 class="widgettitle title-primary center"><?php echo $canvasLabels["sm_c"]; ?></h4>
                    <?php $elementName = 'sm_c'; require(ROOT.'/../src/library/canvas/tpl.element.inc.php'); ?>
                </div>
            </div>
				
            <div class="row-fluid">
                <div class="column" style="width:100%">
                    <h4 class="widgettitle title-primary center"><?php echo $canvasLabels["sm_d"]; ?></h4>
                    <?php $elementName = 'sm_d'; require(ROOT.'/../src/library/canvas/tpl.element.inc.php'); ?>
                </div>
            </div>
				
            <div class="row-fluid">
                <div class="column" style="width:100%">
                    <h4 class="widgettitle title-primary center"><?php echo $canvasLabels["sm_e"]; ?></h4>
                    <?php $elementName = 'sm_e'; require(ROOT.'/../src/library/canvas/tpl.element.inc.php'); ?>
                </div>
            </div>
				
            <div class="row-fluid">
                <div class="column" style="width:100%">
                    <h4 class="widgettitle title-primary center"><?php echo $canvasLabels["sm_g"]; ?></h4>
                    <?php $elementName = 'sm_f'; require(ROOT.'/../src/library/canvas/tpl.element.inc.php'); ?>
                </div>
            </div>
            ...
            <div class="row-fluid">
                <div class="column" style="width:100%">
                    <h4 class="widgettitle title-primary center"><?php echo $canvasLabels["sm_g"]; ?></h4>
                    <?php $elementName = 'sm_g'; require(ROOT.'/../src/library/canvas/tpl.element.inc.php'); ?>
                </div>
            </div>
        </div>
        <div class="clearfix"></div>
