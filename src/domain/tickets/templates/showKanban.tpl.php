...
<script type="text/javascript">
    ...
    jQuery(function() {
        ...
        //2022-09-28 calaw reset search
        jQuery(".reset").on("click", function() {
            jQuery("input").val("")
            jQuery('select[name="searchUsers[]"]').val('')
            jQuery('select[name="searchType"]').val('')
            jQuery('select[name="searchMilestone"]').val('')
            jQuery(".search").click()
    ...
    <div class="maincontentinner">
        ...
        <form action="<?= BASE_URL ?>/tickets/showKanban" method="post">
            ...
            <div class="row">
                ...
                <div class="col-md-4 center">
                    <span class="currentSprint">
                        ...
                        <?php } else { ?>
                            <br />
                            <h4> <a href="<?= BASE_URL ?>/sprints/editSprint" class="sprintModal"><span class="fa fa-rocket"></span> Create your first Sprint</a></h4>
                        <?php } ?>
                    </span>
                </div>
                <div class="col-md-4">
            ...
            <div class="filterBar <?php
                                    ...
                                    if ((count($searchCriteria['users']) == 0 || $searchCriteria['users'] == '') && $searchCriteria['milestone'] == '' && $searchCriteria['searchType'] == '') {
                                        echo "hideOnLoad";
                                    } ?>">
                ...
                <div class="row-fluid" style="opacity:0.4">
                    <div class="pull-right">
                        ...
                        <input type="submit" value="Search" name="search" class="search form-control btn btn-primary" />
                        <input type="button" value="Reset" name="reset" class="reset form-control btn btn-secondary" />
                    ...
                    <div class="filterBoxLeft">
                        ...
                        <div class="form-group">
                            <select data-placeholder="Filter by User..." name="searchUsers[]" multiple="multiple" class="user-select" onchange="">
                                <option value=""></option>
                    ...
                    <div class="filterBoxLeft">
                        ...
                        <div class="form-group">
                            <select data-placeholder="Filter by Milestone..." name="searchMilestone" class="user-select" onchange="">
                    ...
                    <div class="">
                        ...
                        <div class="form-group">
                            <select data-placeholder="Filter by Type..." name="searchType" onchange="">
                ...
                ?>
                    ...
                    <div class="column">
                        ...
                        <h4 class="widgettitle title-primary" style="border-bottom:5px solid <?php echo $color; ?>">
                            ...
                            <?php echo $tickets->stateLabels[$statusRow]; ?>
                        </h4>
                                    ...
                                    <div class="ticketBox moveable container" id="ticket_<?php echo $row["id"]; ?>">
                                                    ...
                                                    <div class="inlineDropDownContainer" style="float:right;">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li id="timerContainer-<?php echo $row['id']; ?>" class="timerContainer">
                                                                <a class="punchIn" href="javascript:void(0);" value="<?php echo $row["id"]; ?>" <?php if ($clockedIn !== false) {
                                                                                                                                                    echo "style='display:none;'";
                                                                                                                                                } ?>><span class="iconfa-time"></span> Start Work</a>

                                                                <a class="punchOut" href="javascript:void(0);" value="<?php echo $row["id"]; ?>" <?php if ($clockedIn === false || $clockedIn["id"] != $row["id"]) {
                                                                                                                                                        echo "style='display:none;'";
                                                                                                                                                    } ?>><span class="iconfa-stop"></span> Stop Work, <?php echo "<span >started at: <span class='time'>" . date("h:i A", $clockedIn["since"]); ?></span></span></a>

                                                                <span class='working' <?php if ($clockedIn === false || $clockedIn["id"] === $row["id"]) {
                                                                                            echo "style='display:none;'";
                                                                                        } ?>>Timer set on another To-Do</span>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6" style="padding-top:3px;">
                                                <a class="userPopover" style="white-space: nowrap;" href="javascript:void(0);" data-html="true" data-content="<?php echo "<input type='radio' name='ticketUserChange_" . $row['id'] . "' id='ticketUserChange" . $row['id'] . "' value='' data-label='nobody' style='float:left; margin-right:10px;' ";
                                                                                                                                                                if ($row['editorId'] == '') echo " checked='selected' ";
                                                                                                                                                                echo "><label for='ticketUserChange" . $row['id'] . "'>Not assigned</label>";
                                                                                                                                                                foreach ($this->get('users') as $user) {
                                                                                                                                                                    echo "<input type='radio' name='ticketUserChange_" . $row['id'] . "' id='ticketUserChange" . $row['id'] . $user['id'] . "' value='" . $user['id'] . "' data-label='" . $user['firstname'] . ", " . $user['lastname'] . "' style='float:left; margin-right:10px;' ";
                                                                                                                                                                    if ($row['editorId'] == $user['id']) echo " checked='selected' ";
                                                                                                                                                                    echo "><label for='ticketUserChange" . $row['id'] . $user['id'] . "'>" . $user['firstname'] . ", " . $user['lastname'] . "</label>"; ?> <?php }     ?>" data-placement="bottom" data-toggle="popover" data-container="body" data-original-title="" title="Who is working on this?">
                                        ...
                                        <div class="right timerContainer" style="float:right" id="timerContainer-<?php echo $row["id"]; ?>">
                                            ...
                                            <a class="effortPopover" href="javascript:void(0);" data-html="true" data-content="<?php echo "<input type='radio' name='ticketEffortChange_" . $row['id'] . "' id='ticketEffortChange" . $row['id'] . "' value='' data-label='Effort not clear' style='float:left; margin-right:10px;' ";
                                                                                                                                if ($row['storypoints'] == '') echo " checked='selected' ";
                                                                                                                                echo "><label for='ticketEffortChange" . $row['id'] . "'>Effort not clear</label>";
                                                                                                                                foreach ($this->get('efforts') as $effortKey => $effortValue) {
                                                                                                                                    echo "<input type='radio' name='ticketEffortChange_" . $row['id'] . "' id='ticketEffortChange" . $row['id'] . $effortKey . "' value='" . $effortKey . "' data-label='" . $effortValue . "' style='float:left; margin-right:10px;' ";
                                                                                                                                    if ($row['storypoints'] == $effortKey) echo " checked='selected' ";
                                                                                                                                    echo "><label for='ticketEffortChange" . $row['id'] . $effortKey . "'>" . $effortValue . "</label>"; ?> <?php }     ?>" data-placement="bottom" data-toggle="popover" data-container="body" data-original-title="" title="How big is this To-Do?">
                                            ...
                                            <?php if ($row['dependingTicketId'] != "" && $row['dependingTicketId'] != 0) { ?>
                                                ...
                                                <a class="milestonePopover" href="javascript:void(0);" data-html="true" data-content="<?php echo "<input type='radio' name='ticketMilestoneChange_" . $row['id'] . "' id='ticketMilestoneChange" . $row['id'] . "0' value='0' data-label='No Milestone' data-color='' style='float:left; margin-right:10px;' ";
                                                                                                                                        if ($row['dependingTicketId'] == 0) echo " checked='selected' ";
                                                                                                                                        echo "><label for='ticketMilestoneChange" . $row['id'] . "0'>No Milestone</label>";
                                                                                                                                        foreach ($this->get('milestones') as $milestone) {
                                                                                                                                            echo "<input type='radio' name='ticketMilestoneChange_" . $row['id'] . "' id='ticketMilestoneChange" . $row['id'] . $milestone->id . "' value='" . $milestone->id . "' data-label='" . $milestone->headline . "' data-color='" . $milestone->tags . "' style='float:left; margin-right:10px;' ";
                                                                                                                                            if ($row['dependingTicketId'] == $milestone->id) echo " checked='selected' ";
                                                                                                                                            echo "><label for='ticketMilestoneChange" . $row['id'] . $milestone->id . "'>" . $milestone->headline . "</label>"; ?> <?php }     ?>" data-placement="bottom" data-toggle="popover" data-container="body" data-original-title="" title="Choose a milestone">
