    ...
    $(document).ready(function() 
        { 
            ...
            $("#date, #invoicedCompDate, #invoicedEmplDate").datepicker({
                ...
                dateFormat: 'dd.mm.yy',
                dayNames: [<?php echo''.$this->__('DAYNAMES').'' ?>],
                dayNamesMin:  [<?php echo''.$this->__('DAYNAMES_MIN').'' ?>],
                monthNames: [<?php echo''.$this->__('MONTHS').'' ?>]
            });
...
<div class="pageheader">
    ...
    <div class="span12">
        ...
        <?php } ?> <input type="submit" value="<?php echo $this->__('SAVE'); ?>"
                    ...
                    value="<?php echo $this->__('SAVE_NEW'); ?>" name="saveNew" class="button" />
