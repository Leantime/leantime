...
<h1><?php echo $this->__('headlines.edit_time') ?></h1>
...
<label for="tickets"><?php echo $this->__('label.ticket') ?></label><br /> <select
...
<a href="index.php?act=timesheets.showMy" class="link"><?php echo $this->__('buttons.back') ?></a>
