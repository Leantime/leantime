                    ...
                    <div class="mediamgr_content">          
                    	...
                    	<ul id='medialist' class='listfile'>
                    		...
                    		<li class="<?php echo $file['moduleId'] ?>">
                              	<a class="imageLink" href="//<?=$_SERVER['SERVER_NAME']?>/download.php?module=<?php echo $file['module'] ?>&encName=<?php echo $file['encName'] ?>&ext=<?php echo $file['extension'] ?>&realName=<?php echo $file['realName'] ?>">
