<?php
	...
	$allProjectTickets = $this->get('allProjectTickets');
?>
...
<div class="pageheader">
    ...
    <div class="pagetitle">
        ...
        <h1><?php echo $this->__('headline.all_projects_tickets') ?></h1>
    </div>
		...
		<table class="table table-bordered" cellpadding="0" cellspacing="0" border="0" id="allProjectsTable">
			...
			<thead>
				<tr>
					...
					<th class="head0"><?php echo $this->__('label.ticket'); ?></th>
				...
				<tr class='gradeA'>
					...
					<td class="center">
                        <table class="table table-bordered" cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tbody>
                                <?php foreach($allProjectTickets[$row['id']] as $ticket): ?>
                                    <tr>
                                        <td>
                                            <a href="<?=BASE_URL ?>/tickets/showTicket/<?php echo $ticket['id'];?>" >
                                                <?php echo $ticket['headline']; ?>
                                            </a>
                                        </td>
                                        <td>
                                            <?php echo $statusLabels[$ticket['status']]["name"]; ?>
                                        </td>
                                    </tr>                        
                                <?php endforeach; ?>
                            </tbody>
