...
<form method="post" action="/retrospectives/delCanvasItem/<?php echo (int)$_GET['id']?>">
    ...
    <a class="btn btn-secondary" href="/retrospectives/delCanvasItem/"><?php echo $this->__("buttons.back") ?></a>
</form>
