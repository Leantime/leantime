...
<div class="maincontent">
            ...
            <div class="col-md-4">
                <div class="pull-right">
                    ...
                    <div class="btn-group mt-1 mx-auto" role="group">
                        <a href="/leancanvas/simpleCanvas" class="btn btn-sm btn-secondary active"><i class="fas fa-columns"></i> Simple Canvas</a>
                        <a href="/leancanvas/showCanvas" class="btn btn-sm btn-secondary"><i class='fas fa-graduation-cap'></i> Full Lean Canvas</a>
                    </div>
                    <?php } ?>
                </div>
            </div>
    ...
    <?php if(count($this->get('allCanvas')) > 0) {?>
        ...
        <div id="sortableBacklog" class="sortableTicketList">
            ...
            <div class="row-fluid" id="firstRow" style="padding-top:10px;">
                        ...
                        <div class="span12">
                            <div class="column">
                                ...
                                <div class="contentInner status_problem">
                                    ...
                                    <?php } ?>    
                                    <br />
                                    <a href="/leancanvas/editCanvasItem&type=solution"  class="canvasModal" id="solution"><span class="iconfa iconfa-plus"></span> Add Solution</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        if(isset($_SESSION['tourActive']) === true && $_SESSION['tourActive'] == 1) {     ?>
                <p class="align-center"><br /><em>Once you feel comfortable with your research go to the</em> <br /><a href="/tickets/roadmap/" class="btn btn-primary"><span class="fas fa-map"></span> Roadmap Planner</a></p>
        <?php } ?>
