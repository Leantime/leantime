...
<?php require(ROOT.'/../src/domain/canvas/templates/showCanvasTop.inc.php'); ?>
    ...
    <?php if(count($this->get('allCanvas')) > 0) { ?>
        ...
        <div id="sortableCanvasKanban" class="sortableTicketList disabled">
            ...
            <div class="row" style="margin-left: 0px; margin-right: 0px">
                <div class="column" style="width:100%">
				    <h4 class="widgettitle title-primary center"><i class="fas <?=$canvasTypes['sb_industry']['icon'] ?>"></i> <?=$this->__($canvasTypes['sb_industry']['title']) ?></h4>
            ...
            <div class="row" style="margin-left: 0px; margin-right: 0px">
                <div class="column" style="width:100%">
                    <h4 class="widgettitle title-primary center"><i class="fas <?=$canvasTypes['sb_description']['icon'] ?>"></i> <?=$this->__($canvasTypes['sb_description']['title']) ?></h4>
            ...
            <div class="row" id="stakeholderRow" style="margin-left: 0px; margin-right: 0px">
                ...
                <div class="column" style="width:25%">
					  <h4 class="widgettitle title-primary center"><i class="fas <?=$canvasTypes['sb_st_decision']['icon'] ?>"></i> <?=$this->__($canvasTypes['sb_st_decision']['title']) ?></h4>
                    <?php $elementName = 'sb_st_decision'; require(ROOT.'/../src/domain/canvas/templates/element.inc.php'); ?>
                </div>
                <div class="column" style="width:25%">
                    <h4 class="widgettitle title-primary center"><i class="fas <?=$canvasTypes['sb_st_experts']['icon'] ?>"></i> <?=$this->__($canvasTypes['sb_st_experts']['title']) ?></h4>
                    <?php $elementName = 'sb_st_experts'; require(ROOT.'/../src/domain/canvas/templates/element.inc.php'); ?>
                </div>
                <div class="column" style="width:25%">
                    <h4 class="widgettitle title-primary center"><i class="fas <?=$canvasTypes['sb_st_support']['icon'] ?>"></i> <?=$this->__($canvasTypes['sb_st_support']['title']) ?></h4>
            ...
            <div class="row" id="financialsRow" style="margin-left: 0px; margin-right: 0px">
                <div class="column" style="width:50%">
                    <h4 class="widgettitle title-primary center"><i class="fas <?=$canvasTypes['sb_budget']['icon'] ?>"></i> <?=$this->__($canvasTypes['sb_budget']['title']) ?></h4>
                    <?php $elementName = 'sb_budget'; require(ROOT.'/../src/domain/canvas/templates/element.inc.php'); ?>
                </div>
                <div class="column" style="width:50%">
                    <h4 class="widgettitle title-primary center"><i class="fas <?=$canvasTypes['sb_time']['icon'] ?>"></i> <?=$this->__($canvasTypes['sb_time']['title']) ?></h4>
                    <?php $elementName = 'sb_time'; require(ROOT.'/../src/domain/canvas/templates/element.inc.php'); ?>
                </div>
            </div>

            <div class="row" id="culturechangeRow" style="margin-left: 0px; margin-right: 0px">
                <div class="column" style="width:50%">
                    <h4 class="widgettitle title-primary center"><i class="fas <?=$canvasTypes['sb_culture']['icon'] ?>"></i> <?=$this->__($canvasTypes['sb_culture']['title']) ?></h4>
                    <?php $elementName = 'sb_culture'; require(ROOT.'/../src/domain/canvas/templates/element.inc.php'); ?>
                </div>
                <div class="column" style="width:50%">
                    <h4 class="widgettitle title-primary center"><i class="fas <?=$canvasTypes['sb_change']['icon'] ?>"></i> <?=$this->__($canvasTypes['sb_change']['title']) ?></h4>
            ...
            <div class="row" style="margin-left: 0px; margin-right: 0px">
                <div class="column" style="width:100%">
                    <h4 class="widgettitle title-primary center"><i class="fas <?=$canvasTypes['sb_principles']['icon'] ?>"></i> <?=$this->__($canvasTypes['sb_principles']['title']) ?></h4>
                    <?php $elementName = 'sb_principles'; require(ROOT.'/../src/domain/canvas/templates/element.inc.php'); ?>
                </div>
            </div>

			<div class="row" style="margin-left: 0px; margin-right: 0px">
                <div class="column" style="width:100%" style="margin-left: 0px; margin-right: 0px">
