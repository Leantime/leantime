...
$canvasName = 'bm';
$canvasTemplate = 'd'; $_SESSION[$canvasName.'template'] = $canvasTemplate;
$canvasTitle = "";
...
<?php require(ROOT.'/../src/library/canvas/tpl.canvasTop.inc.php'); ?>
            ...
            <div class="col-md-4">
                <div class="pull-right">
                    ...
                    <?php if(count($this->get('allCanvas')) > 0) {?>
                        ...
                        <div class="btn-group viewDropDown">
                            <button class="btn dropdown-toggle" data-toggle="dropdown"><?=$this->__("links.$canvasName.d$canvasName".".board") ?> <?=$this->__("links.view") ?></button>
                            <ul class="dropdown-menu">
						      ...
						      <li><a href="<?=BASE_URL ?>/<?=$canvasName ?>canvas/d<?=$canvasName ?>Canvas" class="active"><?=$this->__("links.$canvasName.d$canvasName".".board") ?></a></li>
                            </ul>
                        </div>
        ...
        <div id="sortableCanvasKanban" class="sortableTicketList disabled">
            ...
            <div class="row-fluid" id="firstRow">
                ...
                <div class="column" style="width:13.33%">
                    <h4 class="widgettitle title-primary center"><?php echo $canvasLabels["bm_kad"]; ?></h4>
					<?php $elementName = 'bm_kad'; require(ROOT.'/../src/library/canvas/tpl.element.inc.php'); ?>
                </div>
                <div class="column" style="width:13.33%">
                    <h4 class="widgettitle title-primary center"><?php echo $canvasLabels["bm_kac"]; ?></h4>
					<?php $elementName = 'bm_kac'; require(ROOT.'/../src/library/canvas/tpl.element.inc.php'); ?>
                </div>
                <div class="column" style="width:13.33%">
                    <h4 class="widgettitle title-primary center"><?php echo $canvasLabels["bm_kao"]; ?></h4>
					<?php $elementName = 'bm_kao'; require(ROOT.'/../src/library/canvas/tpl.element.inc.php'); ?>
                </div>
		    </div>
            <div class="row-fluid" id="secondRow">
                <div class="column" style="width:20%">
                    <h4 class="widgettitle title-primary center"><?php echo $canvasLabels["bm_cj"]; ?></h4>
					<?php $elementName = 'bm_cj'; require(ROOT.'/../src/library/canvas/tpl.element.inc.php'); ?>
                </div>
                <div class="column" style="width:20%">
				...
				<div class="column" style="width:20%">
                    <h4 class="widgettitle title-primary center"><?php echo $canvasLabels["bm_ops"]; ?></h4>
					<?php $elementName = 'bm_ops'; require(ROOT.'/../src/library/canvas/tpl.element.inc.php'); ?>
                </div>

				<div class="column" style="width:40%">
                  <div class="row-fluid" id="secondRowTop">
					<div class="column" style="width:50%; padding-top: 0px">
                      <h4 class="widgettitle title-primary center"><?php echo $canvasLabels["bm_krp"]; ?></h4>
					  <?php $elementName = 'bm_krp'; require(ROOT.'/../src/library/canvas/tpl.element.inc.php'); ?>
                    </div>
                    <div class="column" style="width:50%; padding-top: 0">
                      <h4 class="widgettitle title-primary center"><?php echo $canvasLabels["bm_krc"]; ?></h4>
					  <?php $elementName = 'bm_krc'; require(ROOT.'/../src/library/canvas/tpl.element.inc.php'); ?>
                    </div>
                  </div>
                  <div class="row-fluid" id="secondRowBottom">
					<div class="column" style="width:50%; padding-bottom: 0">
                      <h4 class="widgettitle title-primary center"><?php echo $canvasLabels["bm_krl"]; ?></h4>
					  <?php $elementName = 'bm_krl'; require(ROOT.'/../src/library/canvas/tpl.element.inc.php'); ?>
                    </div>
                    <div class="column" style="width:50%; padding-bottom: 0">
                      <h4 class="widgettitle title-primary center"><?php echo $canvasLabels["bm_krs"]; ?></h4>
					  <?php $elementName = 'bm_krs'; require(ROOT.'/../src/library/canvas/tpl.element.inc.php'); ?>
					</div>
                  </div>
                </div>
		    </div>
            <div class="row-fluid" id="thirdRow">
    ...
    ?>
        <br /><small class="align-center"><?=$this->__('text.bm.dbm.canvas_is_adapted_message') ?></small>
    </div>
</div>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        leantime.<?=$canvasName ?>canvasController.setDbmCanvasHeights();
