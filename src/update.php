                ...
                <div class="regcontent"  id="login" style="margin-left: 90px;">
                    ...
                    <?php
                        ...
                        if($success === true) {
                            echo "
                                <div class='inputwrapper login-alert'>
                                    <div class='alert alert-success'>Update was successful you can now login. <br /><a href='/'>Go to login</a></div>
                                </div>";
                        }
                    ?>
                    <?php if($success !== true) { ?>
                    <form action="/update" method="post" class="registrationForm">
