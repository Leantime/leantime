...
class pdflabel extends fpdf {
	...
	var $_Avery_Labels = array(
		...
		'L7160'=> array('paper-size'=>'A4',	    'metric'=>'mm',	'marginLeft'=>5.4, 		'marginTop'=>15, 		'NX'=>3, 	'NY'=>7, 	'SpaceX'=>2.5, 	    'SpaceY'=>0, 	'width'=>63.5, 		'height'=>38.1,		'font-size'=>9),
		'3422' => array('paper-size'=>'A4',		'metric'=>'mm',	'marginLeft'=>0,		'marginTop'=>8.5, 		'NX'=>3,	'NY'=>8,	'SpaceX'=>0,		'SpaceY'=>0,	'width'=>70,		'height'=>35,		'font-size'=>9),
		'3481' => array('paper-size'=>'A4',		'metric'=>'mm',	'marginLeft'=>1.7,		'marginTop'=>5, 		'NX'=>3,	'NY'=>7,	'SpaceX'=>0,		'SpaceY'=>0,	'width'=>70,		'height'=>41,		'font-size'=>9)
	);

	// Constructor
	function pdflabel($format, $unit='mm', $posX=1, $posY=1) {
		if (is_array($format)) {
			// Custom format
			$Tformat = $format;
		} else {
	...
	// Print a label
	function Add_Label($author, $text) {
		$this->_COUNTX++;
		...
		$this->MultiCell($this->_Width - $this->_Padding, $this->_Line_Height, $author, 0, 'L');
