...
class language {
	...
	public function readIni() {
		...
		if(file_exists(''.$this->iniFolder.''.$this->language.'/'.$this->language.'.'.$this->module.'.ini') === true){
				
			$this->ini_array = parse_ini_file(''.$this->iniFolder.''.$this->language.'/'.$this->language.'.'.$this->module.'.ini');

		}else{

			$this->ini_array[0] = 'Datei nicht vorhanden';
