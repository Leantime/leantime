...
<div class="pageheader">
    ...
    <div class="pull-right padding-top">
        <a href="<?=BASE_URL ?>/pgmPro/showAll" class="backBtn"><i class="far fa-arrow-alt-circle-left"></i> <?php echo $this->__('links.go_back') ?></a>
    </div>

    <div class="pageicon"><span class="fa fa-suitcase"></span></div>
    <div class="pagetitle">
        <h5><?php echo $this->__('label.program_manager') ?></h5>
        <h1><?php echo $this->__('headline.new_program') ?></h1>
    </div>
...
<div class="maincontent">
    <div class="maincontentinner">
        ...
        <div class="tabbedwidget tab-primary projectTabs">
            ...
            <ul>
                <li><a href="#projectdetails"><?php echo $this->__('tabs.programdetails'); ?></a></li>
            </ul>
                            ...
                            <div class="row-fluid">
                                <div class="span12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="name" class="main-title-input" style="width:99%"  value="<?php $this->e($program['name']) ?>" placeholder="<?=$this->__('input.placeholders.enter_title_of_program')?>"/>
                        ...
                        <div class="span4">
                                    ...
                                    <select name="clientId" id="clientId">
                                        ...
                                        <?php foreach ($this->get('clients') as $row) { ?>
                                            <option value="<?php echo $row['id']; ?>"
                                                <?php if ($program['clientId'] == $row['id']) {
                                                    ?> selected=selected
                            ...
                            <div class="row-fluid marginBottom">
                                <div class="span12">
                                    ...
                                    <?php echo $this->__('text.who_can_access_program'); ?>
                                    <br /><br />
