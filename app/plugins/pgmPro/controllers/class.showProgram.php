...
namespace leantime\plugins\controllers {
    ...
    class showProgram extends controller
    {
        //services
        ...
        public function run()
        {
            ...
            if (isset($_GET['id']) === true) {
                ...
                $_SESSION['lastPage'] = BASE_URL . "/pgmPro/showProgram/" . $id;
                ...
                $this->tpl->assign('program', $project);
                ...
                $this->tpl->display('pgmPro.showProgram');
            } else {
