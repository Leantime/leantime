...
<form class="onboardingModal step1" method="post" action="<?=BASE_URL ?>/help/firstLogin?step=2">
    ...
    <div class="row">
        <div class="col-md-6">
            <h1>Hi, there!</h1>
            <p>We're so excited you are here. Before we get started let's go through a few initial set up steps.<br /></p>
...
jQuery(document).ready(function(){
    ...
    jQuery(".profileBox").hover(function(){
...
function setPlan(plan) {
    jQuery("#projectPlan, #userPlan").removeClass("active");

    jQuery("#"+plan+"Plan").addClass("active");

    jQuery("#setPlan").val(plan);

    jQuery("#planPickerSubmit").removeAttr("disabled");
}
