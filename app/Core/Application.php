...
use Leantime\Core\Bootstrap\AliasLoader;
use Leantime\Core\Bootstrap\Detector;
use Leantime\Core\Bootstrap\LoadEnvironmentVariables;
use Leantime\Core\Bootstrap\LocaleUpdated;
use Leantime\Core\Bootstrap\Mix;
use Leantime\Core\Events\EventDispatcher;
use Leantime\Core\Plugins\PackageManifest;
use Leantime\Core\ProviderRepository;
...
class Application extends Container implements ApplicationContract, CachesConfiguration, CachesRoutes, HttpKernelInterface
{
    ...
    public function bootstrapWith(array $bootstrappers)
    {
        ...
        foreach ($bootstrappers as $bootstrapper) {
            $this['events']->dispatch('bootstrapping_'.$bootstrapper, [$this]);

            $this->make($bootstrapper)->bootstrap($this);

            $this['events']->dispatch('bootstrapped_'.$bootstrapper, [$this]);
        }
    }
    ...
    public function afterLoadingEnvironment(Closure $callback)
    {
        ...
        //Leantime: This could our EnvironmentLoader
    ...
    {
        $this['events']->listen('bootstrapping_'.$bootstrapper, $callback);
    }
    ...
    {
        $this['events']->listen('bootstrapped_'.$bootstrapper, $callback);
    }
    ...
    protected function bindPathsInContainer()
    {
        ...
        $this->useBootstrapPath($this->basePath('Core/Bootstrap'));

        $this->useLangPath($this->basePath('Core/Language'));
    }
    ...
    {
        return $this->environmentPath ?: $this->basePath."/config";
    }
    ...
    public function runningInConsole()
    {
        if ($this->isRunningInConsole === null) {
            $this->isRunningInConsole = defined('LEAN_CLI') && LEAN_CLI ?? (\PHP_SAPI === 'cli' || \PHP_SAPI === 'phpdbg');
        }
    ...
    public function boot()
    {
        ...
        array_walk($this->serviceProviders, function ($p) {
            ...
            $provider = new \ReflectionClass($p);
            self::dispatch_event("booting".$provider->getName());
    ...
    {
        return $this->joinPaths($this->basePath(),'cache/services.php');
    }
    ...
    {
        return $this->joinPaths($this->basePath(),'cache/packages.php');
    }
    ...
    {
        return $this->joinPaths($this->basePath(),'cache/config.php');
    }
    ...
    {
        return $this->joinPaths($this->basePath(),'cache/routes.php');
    }
    ...
    {
        return $this->joinPaths($this->basePath(),'cache/events.php');
    }
