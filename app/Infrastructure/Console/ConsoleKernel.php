...
namespace Leantime\Infrastructure\Console;
...
use Leantime\Infrastructure\Console\Application as LeantimeCli;
...
class ConsoleKernel extends Kernel implements ConsoleKernelContract
{
    ...
    protected $bootstrappers = [
        ...
        \Leantime\Infrastructure\Bootstrap\SetRequestForConsole::class,
