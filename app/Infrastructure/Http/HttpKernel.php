...
class HttpKernel extends Kernel
{
    ...
    protected $bootstrappers = [
        ...
        \Leantime\Infrastructure\Bootstrap\LoadConfig::class,
    ...
    protected $middleware = [
        ...
        \Leantime\Infrastructure\Http\Middleware\TrustProxies::class,

        \Leantime\Infrastructure\Sessions\Middleware\StartSession::class,
        ...
        \Leantime\Infrastructure\Plugins\Middleware\LoadPlugins::class,

        \Leantime\Infrastructure\Http\Middleware\InitialHeaders::class,
        ...
        \Leantime\Infrastructure\Http\Middleware\RequestRateLimiter::class,
        \Illuminate\Http\Middleware\HandleCors::class,
        \Illuminate\Foundation\Http\Middleware\ValidatePostSize::class,
        \Leantime\Infrastructure\Http\Middleware\TrimStrings::class,
        \Illuminate\Foundation\Http\Middleware\ConvertEmptyStringsToNull::class,
        \Leantime\Infrastructure\Http\Middleware\SetCacheHeaders::class,
