          ...
          <div class="row-fluid"><div class="column" style="width: 100%; min-width: calc(4 * 250px);">
            ...
            <div class="row canvas-row" id="secondRow">
              <div class="column" style="width: 25%">
                <?php $elementName = 'em_see';
                require($this->getTemplatePath('canvas', 'element.inc.php')); ?>
              </div>
              <div class="column" style="width: 25%">
                <?php $elementName = 'em_say';
                require($this->getTemplatePath('canvas', 'element.inc.php')); ?>
              </div>
              <div class="column" style="width: 25%">
                <?php $elementName = 'em_do';
                require($this->getTemplatePath('canvas', 'element.inc.php')); ?>
              </div>
              <div class="column" style="width: 25%">
                <?php $elementName = 'em_hear';
                require($this->getTemplatePath('canvas', 'element.inc.php')); ?>
              </div>
            </div>
            ...
            <div class="row canvas-row" id="thirdRow">
              <div class="column" style="width: 50%">
                <?php $elementName = 'em_pains';
                require($this->getTemplatePath('canvas', 'element.inc.php')); ?>
              </div>
              <div class="column" style="width: 50%">
                <?php $elementName = 'em_gains';
                require($this->getTemplatePath('canvas', 'element.inc.php')); ?>
              </div>
            </div>
