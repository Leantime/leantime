...
<h4 class="widgettitle title-light"><i class="fa fa-key"></i> <?php echo $this->__('headlines.api_key'); ?></h4>
...
<form action="<?=BASE_URL?>/api/apiKey/<?=(int)$_GET['id'] ?>" method="post" class="stdform formModal" >
        ...
        <div class="row" >
            <div class="col-md-6">
                ...
                <label><?php echo $this->__('label.key'); ?></label><div class="clearfix"></div>
