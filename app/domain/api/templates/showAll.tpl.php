...
<div class="pageheader">
    ...
    <div class="pageicon"><span class="fa fa-"></span></div>
    <div class="pagetitle">
        <h5><?php echo $this->__('label.administration') ?></h5>
        <h1><?php echo $this->__('headlines.api_keys'); ?></h1>
    </div>
</div><!--pageheader-->
...
<div class="maincontent">
    <div class="maincontentinner">
        ...
        <div class="row">
            <div class="col-md-6">
                <a href="<?=BASE_URL ?>/api/newAPIKey" class="btn btn-primary userEditModal"><i class='fa fa-plus'></i> <?=$this->__('buttons.add_api_key') ?> </a>
            </div>
