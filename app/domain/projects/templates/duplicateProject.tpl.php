...
<form class="formModal" method="post" action="<?=BASE_URL ?>/projects/duplicateProject/<?php echo $project['id'];?>">
    ...
    <input type="text" name="startDate" class="projectDateFrom" value="<?php echo $tpl->getFormattedDateString(date("Y-m-d")) ?>" placeholder="<?=$tpl->__('language.jsdateformat') ?>" id="sprintStart" /><br />
