                ...
                <div class="col-md-5">
                    <div class="pull-right">
                        ...
                        <div class="btn-group viewDropDown">
                            <button class="btn dropdown-toggle" type="button" data-toggle="dropdown"><?=$tpl->__("links.table") ?> <?=$tpl->__("links.view") ?></button>
                            <ul class="dropdown-menu">
                                <li><a href="<?=BASE_URL ?>/tickets/roadmap" ><?=$tpl->__("links.gantt_view") ?></a></li>
                                <li><a href="<?=BASE_URL ?>/tickets/showAllMilestones" class="active"><?=$tpl->__("links.table") ?></a></li>
