...
<body class="loginpage" style="height:100%; ">
    <div class=""
        style="background:url({{BASE_URL}}/assets/images/spotlightBg.png); background-size: cover; height:100%; background-attachment: fixed;">
        <div style="    width: 100%;
    height: 100%;
                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="regpanelinner" style="padding:30px;">
                            ...
                            <a href=""><img src="{{ BASE_URL }}/dist/images/logo_blue.svg"
                    ...
                    <div class="col-md-5 regLeft"
                        style="position:relative; background:var(--element-gradient); padding:20px; height:auto;">
