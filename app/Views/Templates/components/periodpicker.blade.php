...
<div {{ $attributes->merge(['class' => 'periodPicker tw-flex tw-items-center tw-gap-2 tw-flex-wrap']) }}>
    ...
    <div class="btn-group" role="group">
        ...
        <a href="{{ $url }}?preset=custom"
           onclick="var f=jQuery(this).closest('.periodPicker').find('.periodPickerCustom'); var show=!f.is(':visible'); f.css('display', show ? 'flex' : 'none'); this.setAttribute('aria-expanded', show ? 'true' : 'false'); return false;"
