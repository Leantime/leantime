        ...
        foreach ($array as $headline) {
            if ((int) $currentParent === (int) $headline->parent) {
                ...
                echo '
                    ...
                    $headline->id .
                    '">' .
                    $tplObject->escape($headline->title) .
                    '';
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="maincontentinner">
                    ...
                    echo '' .
                        $tpl->__('text.create_new_wiki') .
                        "<br /><br />
                                                                                    <a href='#/wiki/wikiModal/' class='inlineEdit btn btn-primary'>" .
                            ...
                            <div class="col-md-12" style="">
                                <div class="maincontentinner">
                                    ...
                                    <div class="creationLinks">
                                        <a class="inlineEdit " href="#/wiki/articleDialog/"><i class="fa fa-plus"></i>
                                            <?= $tpl->__('link.create_article') ?></a>
                                    </div>
                                    <?php } ?>
                    ...
                    <div class="col-md-9" style="text-align: center">
                        <div class="maincontentinner">
                            <div class="articleWrapper">
                                ...
                                <div class="right">
                                    <a class="btn btn-default round-button"
                                        href="#/wiki/articleDialog/<?= $currentArticle->id ?>"><i
                                            class='fa fa-edit'></i></a>
                                    <a class="dropdown-toggle btn btn-default round-button" data-toggle="dropdown"
                                        href="javascript:void(0)"
                                        onclick="leantime.snippets.copyToClipboard('<?= BASE_URL ?>/wiki/show/<?= $currentArticle->id ?>&projectId=<?= session('currentProject') ?>')"><i
                                ...
                                <div id="comments">
                                    <h4 class="widgettitle title-light"><span
                                            class="fa fa-comments"></span><?php echo $tpl->__('subtitles.discussion'); ?></h4>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="maincontentinner">
                            ...
                            echo '' .
                                $tpl->__('text.create_new_content') .
                                "<br /><br />
                                                                                                    <a href='#/wiki/articleDialog/' class='inlineEdit btn btn-primary'><i class='fa fa-plus'></i> " .
                                $tpl->__('link.create_article') .
                                '</a><br/><br/>';
