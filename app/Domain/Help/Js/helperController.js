...
//Functions
export const showHelperModal = function (module, minW, minH) {
    jQuery(document).ready(function () {
        jQuery.nmManual(
            appUrl + "/help/showOnboardingDialog?module=" + module,
            {sizes: {
                minW: minW || 200,
                minH: minH || 500,
                },
...
//Functions
export const hideAndKeepHidden = function (module) {
    updateUserModalSettings(module);
    jQuery.nmTop().close();
};
...
export const startKanbanTour = function () {
...
export const firstLoginModal = function () {
