<div class="center padding-lg">
    ...
    <x-globals::undrawSvg
        ...
        maxheight="auto"
        height="250px"
        headline="Define your projects with ease"
    ></x-globals::undrawSvg>
    <br />
    ...
    <x-globals::forms.button link="{{ BASE_URL }}/valuecanvas/showCanvas" type="primary">Create a Project Value Canvas</x-globals::forms.button><br />
