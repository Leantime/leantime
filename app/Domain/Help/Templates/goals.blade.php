<div class="center padding-lg">
    ...
    <div style="font-size:var(--font-size-l);">
        ...
        <div class="center">
            ...
            <x-globals::forms.button link="javascript:void(0)" type="primary" onclick="leantime.helperController.closeModal(); leantime.helperController.startGoalTour();">{{ __("buttons.start_tour") }} <x-globals::elements.icon name="arrow_forward" /></x-globals::forms.button>
        </div>
