            ...
            <div style="font-size:var(--font-size-l);">
                ...
                <div class="tw:flex tw:w-full tw:justify-evenly tw:gap-5">
                    <div class="tw:flex-1" style="background:var(--dropdown-link-hover-bg); padding:15px; border-radius:var(--box-radius);">
                        ...
                        <a href="https://www.linkedin.com/in/marcelfolaron/" target="_blank" aria-label="Marcel Folaron on LinkedIn"><i class="fa fa-linkedin"></i></a>
                    </div>
                    ...
                    <div class="tw:flex-1" style="background:var(--dropdown-link-hover-bg); padding:15px; border-radius:var(--box-radius);">
                        ...
                        <a href="https://www.linkedin.com/in/gloriafolaron/" target="_blank" aria-label="Gloria Folaron on LinkedIn"><i class="fa fa-linkedin"></i></a>
                    </div>
                </div>
