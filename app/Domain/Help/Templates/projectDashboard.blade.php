<div class="center padding-lg" style="width:800px;">
    ...
    <div class="onboarding" style="font-size:var(--font-size-l);">
        ...
        <div class="center">
            ...
            <x-globals::forms.button link="javascript:void(0)" type="primary" onclick="leantime.helperController.closeModal(); leantime.helperController.startProjectDashboardTour();">{{ __("buttons.start_tour") }} <i class="fa-solid fa-arrow-right"></i></x-globals::forms.button>
        </div>
