<div class="center padding-lg" style="width:800px;">
    <div>
        <x-globals::undrawSvg image="undraw_social_serenity_vhix.svg" maxWidth="auto"  maxheight="auto" height="250px" headline="{{ __('headlines.welcome') }}"></x-globals::undrawSvg>
    </div>
    <div class="onboarding" style="font-size:var(--font-size-l);">
        ...
        <br /><br />
        <x-globals::forms.button link="javascript:void(0)" type="primary" onclick="leantime.helperController.hideAndKeepHidden('dashboard'); leantime.helperController.startProjectDashboardTour();">{{ __("buttons.lets_go") }} <x-globals::elements.icon name="arrow_forward" /></x-globals::forms.button>
