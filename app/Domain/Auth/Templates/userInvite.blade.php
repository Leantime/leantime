...
<div class="regcontent">
    ...
    <form id="resetPassword" action="" method="post">
        ...
        <div class="">
            ...
            <x-globals::forms.input name="name" style="margin-bottom:15px" id="name" placeholder="<?php echo $tpl->language->__("input.placeholders.name"); ?>" value="<?=$tpl->escape($user['firstname']); ?>" />
        </div>
        <div class="">
            <label for="jobTitle"><?php echo $tpl->language->__("label.role_or_title"); ?></label>
            <x-globals::forms.input name="jobTitle" id="jobTitle" style="margin-bottom:15px" placeholder="<?php echo $tpl->language->__("input.placeholders.jobtitle"); ?>" value="<?=$tpl->escape($user['jobTitle']); ?>" />

        </div>
        <div class="">
            <label for="password"><?php echo $tpl->language->__("label.password"); ?></label>
            <x-globals::forms.input type="password" name="password" autocomplete="off" id="password" style="margin-bottom:15px" placeholder="<?php echo $tpl->language->__("input.placeholders.enter_new_password"); ?>" />
