    ...
    <form class="formModal" method="post" action="<?= BASE_URL ?>/<?= $canvasName ?>canvas/editCanvasItem/<?php echo $id; ?>">
        ...
        <?php if ($dataLabels[1]['active']) { ?>
          <label><?= $tpl->__($dataLabels[1]['title'].'.'.$tpl->escape($canvasItem['box'])) ?></label>
            ...
            <?php } else { ?>
                <textarea style="width:100%" rows="3" cols="10" name="<?= $dataLabels[1]['field'] ?>" class="modalTextArea simpleEditor"><?= $canvasItem[$dataLabels[1]['field']] ?></textarea><br />
            <?php } ?>
        <?php } else { ?>
        ...
        <?php if ($dataLabels[2]['active']) { ?>
          <label><?= $tpl->__($dataLabels[2]['title'].'.'.$tpl->escape($canvasItem['box'])) ?></label>
            ...
            <?php } else { ?>
                <textarea style="width:100%" rows="3" cols="10" name="<?= $dataLabels[2]['field'] ?>" class="modalTextArea simpleEditor"><?= $canvasItem[$dataLabels[2]['field']] ?></textarea><br />
            <?php } ?>
        <?php } else { ?>
        ...
        <?php if ($dataLabels[3]['active']) { ?>
          <label><?= $tpl->__($dataLabels[3]['title'].'.'.$tpl->escape($canvasItem['box'])) ?></label>
            ...
            <?php } else { ?>
                <textarea style="width:100%" rows="3" cols="10" name="<?= $dataLabels[3]['field'] ?>" class="modalTextArea simpleEditor"><?= $canvasItem[$dataLabels[3]['field']] ?></textarea><br />
            <?php } ?>
        <?php } else { ?>
