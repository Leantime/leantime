<div class="" style="min-width:50%;">
    ...
    <x-globals::forms.button link="{{ BASE_URL }}/dashboard/home?resetDashboard=true" type="secondary" outline icon="fa-solid fa-arrow-rotate-left" class="pull-right" style="margin-bottom:10px;">Reset Dashboard</x-globals::forms.button>
