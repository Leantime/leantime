...
<div class="regcontent" id="login">
    ...
    <form action="{{ BASE_URL }}/install/update" method="post" class="registrationForm">
        ...
        <p><x-global::button submit type="primary" name="updateAction" onClick="this.form.submit(); this.disabled=true; this.value='Updating…';">{{ $tpl->language->__('buttons.update_now') }}</x-global::button></p>
    </form>
</div>
