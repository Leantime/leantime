        ...
        <div class="col-md-8">
            ...
            <div class="maincontentinner z-20">
                ...
                <div class="readMoreBox">
                    <div class="mce-content-body kanbanContent closed max-h-[200px] readMoreContent pb-[30px]" id="projectDescription">
                    ...
                    @foreach($tickets as $row)
                        <li class="ui-state-default" id="ticket_{!! $row['id'] !!}">
                            <div class="ticketBox fixed priority-border-{!! $row['priority'] !!}" data-val="{!! $row['id'] !!}">
                                <div class="row">
                                    <div class="col-md-12 timerContainer py-[5px] px-[15px]" id="timerContainer-{!! $row['id'] !!}">
