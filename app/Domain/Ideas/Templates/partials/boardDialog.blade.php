...
<x-global::content.modal.form
    ...
    <div class="modal-body">
        <x-global::forms.text-input type="text" name="canvastitle" value="{{ $canvasTitle }}" {{-- labelText="{{ __('label.title_new') }}" --}}
            placeholder="{{ __('input.placeholders.enter_title_for_board') }}" variant="title" />
    </div>
    <div class="modal-footer">
        @if (isset($_GET['id']))
            <x-global::forms.button scale="xs" type="submit" content-role="primary" name="newCanvas">
