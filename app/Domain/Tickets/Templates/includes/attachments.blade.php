        ...
        <li class="<?php echo $file['moduleId'] ?>">
            <div class="inlineDropDownContainer dropright" style="float:right;">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="{{ BASE_URL }}/files/get?module=<?php echo $file['module'] ?>&encName=<?php echo $file['encName'] ?>&ext=<?php echo $file['extension'] ?>&realName=<?php echo $file['realName'] ?>" target="_blank">{{ __("links.download") }}</a></li>

                    <?php
                    if ($login::userIsAtLeast($roles::$editor)) { ?>
                        <li><a href="{{ BASE_URL }}/tickets/showTicket/<?php echo $ticket->id ?>?delFile=<?php echo $file['id'] ?>" class="delete"><i class="fa fa-trash"></i> {{ __("links.delete") }}</a></li>
                    <?php  } ?>
