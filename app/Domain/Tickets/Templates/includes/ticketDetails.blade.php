...
<div class="row">
    <div class="col-md-9">
        <div class="row marginBottom">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    <input type="text" value="<?php $tpl->e($ticket->headline); ?>" name="headline" class="main-title-input "
                ...
                <div class="form-group" id="descriptionEditor" style="display:none;">
                    <x-global::forms.text-editor name="description" customId="ticketDescription" :type="EditorTypeEnum::Complex->value" :value="$ticket->description !== null ? $ticket->description : ''" />
                    <br />
                </div>
        ...
        <div class="row">
            <div class="col-md-12" style="margin-top:15px;">
                ...
                <input type="submit" name="saveAndCloseTicket" onclick="jQuery('#saveAndCloseButton').val('1');"
        ...
        <h4 class="widgettitle title-light"><span class="fa-solid fa-comments"></span>{{ __('subtitles.discussion') }}
        </h4>
        ...
        <div class="row-fluid">
            <form method="post" action="{{ BASE_URL }}/tickets/showTicket/<?php echo $ticket->id; ?>" class="formModal">
                ...
                @include('comments::includes.generalComment', [
                    'formUrl' => BASE_URL . '/tickets/showTicket/' . $ticket->id,
                ])
            </form>
        </div>
        <?php } ?>
    ...
    <div class="col-md-3">
        ...
        <div class="row marginBottom">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <x-global::forms.select name="projectId" class="w-full" labelText="{!! __('label.project') !!}">
                        @foreach ($allAssignedprojects as $project)
                            <x-global::forms.select.select-option value="{{ $project['id'] }}" :selected="$ticket->projectId == $project['id'] ||
                            ...
                            <x-global::forms.select name="dependingTicketId" class="span11">
                                ...
                                @if (is_array($ticketParents = $tpl->get('ticketParents')))
                                    @foreach ($ticketParents as $ticketRow)
                                        <x-global::forms.select.select-option value="{{ $ticketRow->id }}"
                ...
                <div class="form-group">
                    <div class="">
                        <x-global::forms.select id="status-select" class="span11" name="status"
                            labelText="{!! __('label.todo_status') !!}" :placeholder="isset($ticket->status) ? $statusLabels[$ticket->status]['name'] ?? '' : ''">
                            @foreach ($statusLabels as $key => $label)
                                <x-global::forms.select.select-option value="{{ $key }}" :selected="$ticket->status == $key">
                    ...
                    <div class="">
                        <x-global::forms.select id="type" name="type" class="span11">
                            @foreach ($ticketTypes as $types)
                                <x-global::forms.select.select-option value="{{ strtolower($types) }}"
                    ...
                    <div class="">
                        <x-global::forms.select id="priority" name="priority" class="span11">
                            ...
                            @foreach ($tpl->get('priorities') as $priorityKey => $priorityValue)
                                <x-global::forms.select.select-option value="{{ $priorityKey }}" :selected="$priorityKey == $ticket->priority">
                                    {!! $priorityValue !!}
                                </x-global::forms.select.select-option>
                            @endforeach
                        </x-global::forms.select>
                ...
                <div class="form-group">
                    <x-global::forms.select id="storypoints" name="storypoints" class="span11"
                        ...
                        @foreach ($tpl->get('efforts') as $effortKey => $effortValue)
                            <x-global::forms.select.select-option value="{{ $effortKey }}" :selected="$effortKey == $ticket->storypoints">
                                {!! $effortValue !!}
                            </x-global::forms.select.select-option>
                        @endforeach
                    </x-global::forms.select>
        ...
        <div class="row marginBottom">
            <div class="col-md-12">
                <h5 class="accordionTitle" id="accordion_link_tickets-organization"
                    style="padding-bottom:15px; font-size:var(--font-size-l)">
                    <a href="javascript:void(0)" class="accordion-toggle" id="accordion_toggle_tickets-organization"
                ...
                <div class="simpleAccordionContainer" id="accordion_content-tickets-organization"
                    ...
                    <div class="form-group">
                        <x-global::forms.select id="sprint-select" name="sprint" class="span11"
                            labelText="{!! __('label.sprint') !!}" :placeholder="$ticket->sprint">
                            <x-global::forms.select.select-option value="">
                                {!! __('label.backlog') !!}
                            </x-global::forms.select.select-option>
                            ...
                            @if ($tpl->get('sprints'))
                                @foreach ($tpl->get('sprints') as $sprintRow)
                                    <x-global::forms.select.select-option value="{{ $sprintRow->id }}"
    ...
    <div class="row marginBottom">
        <div class="col-md-12">
            <h5 class="accordionTitle" id="accordion_link_tickets-people"
                style="padding-bottom:15px; font-size:var(--font-size-l)">
                <a href="javascript:void(0)" class="accordion-toggle" id="accordion_toggle_tickets-people"
            ...
            <div class="simpleAccordionContainer" id="accordion_content-tickets-people" style="padding-left:0">
                ...
                <div class="form-group">
                    <x-global::forms.select name="editorId" id="editorId" class="user-select span11"
                        :placeholder="__('label.filter_by_user')" labelText="{!! __('label.editor') !!}" style="width:175px;">
                        <x-global::forms.select.select-option value="">
                            {!! __('label.not_assigned_to_user') !!}
                        </x-global::forms.select.select-option>

                        @foreach ($tpl->get('users') as $userRow)
                            <x-global::forms.select.select-option value="{{ $userRow['id'] }}" :selected="$ticket->editorId == $userRow['id']">
                    ...
                    @if ($login::userIsAtLeast($roles::$editor))
                        <small style="margin-top:-5px; display:block">
                            <a href="javascript:void(0);"
                                onclick="jQuery('#editorId').val({{ session('userdata.id') }}).trigger('chosen:updated');">
        ...
        <div class="row marginBottom">
            <div class="col-md-12">
                <h5 class="accordionTitle" id="accordion_link_tickets-dates"
                    style="padding-bottom:15px; font-size:var(--font-size-l)">
                    <a href="javascript:void(0)" class="accordion-toggle" id="accordion_toggle_tickets-dates"
                ...
                <div class="simpleAccordionContainer" id="accordion_tickets-dates" style="padding-left:0">
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            ...
                            <input type="text" class="dates" style="width:200px;" id="submittedDate"
                                disabled="disabled" value="<?= format($ticket->date)->date() ?>" name="date" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <input type="text" class="dates" style="width:100px;" id="deadline"
                                autocomplete="off" value="<?= format($ticket->dateToFinish)->date() ?>"
                                name="dateToFinish" placeholder="<?= $tpl->__('language.dateformat') ?>" />

                            <input type="time" class="timepicker" style="width:120px;" id="dueTime"
                                autocomplete="off" value="<?= format($ticket->dateToFinish)->time24() ?>"
                                name="timeToFinish" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <input type="text" class="editFrom" style="width:100px;" name="editFrom"
                                autocomplete="off" value="<?= format($ticket->editFrom)->date() ?>"
                                placeholder="<?= $tpl->__('language.dateformat') ?>" />
                            <input type="time" class="timepicker" style="width:120px;" id="timeFrom"
                                autocomplete="off" value="<?= format($ticket->editFrom)->time24() ?>"
                                name="timeFrom" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <input type="text" class="editTo" style="width:100px;" name="editTo"
                                autocomplete="off" value="<?= format($ticket->editTo)->date() ?>"
                                placeholder="<?= $tpl->__('language.dateformat') ?>" />
                            <input type="time" class="timepicker" style="width:120px;" id="timeTo"
                                autocomplete="off" value="<?= format($ticket->editTo)->time24() ?>" name="timeTo" />
                        </div>
                    </div>
        ...
        <div class="row marginBottom">
            <div class="col-md-12">
                ...
                <h5 class="accordionTitle" id="accordion_link_tickets-timetracking"
                    style="padding-bottom:15px; font-size:var(--font-size-l)">
                    <a href="javascript:void(0)" class="accordion-toggle" id="accordion_toggle_tickets-timetracking"
                ...
                <div class="simpleAccordionContainer" id="accordion_content-tickets-timetracking"
                    style="padding-left:0">

                    <div class="form-group">
                        <label class=" control-label">{{ __('label.planned_hours') }}</label>
                        <div class="">
                            <input type="text" value="<?php $tpl->e($ticket->planHours); ?>" name="planHours"
                                style="width:90px;" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <input type="text" value="<?php $tpl->e($ticket->hourRemaining); ?>" name="hourRemaining"
                                style="width:90px;" />
                            <a href="javascript:void(0)" class="infoToolTip" data-placement="left"
                                data-toggle="tooltip"
                                data-tippy-content="{{ __('tooltip.how_many_hours_remaining') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <input type="text" disabled="disabled" value="<?php echo $tpl->get('timesheetsAllHours'); ?>"
                                style="width:90px;" />
                        </div>
                    </div>
