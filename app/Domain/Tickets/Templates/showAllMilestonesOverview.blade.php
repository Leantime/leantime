                                ...
                                <?php if ($login::userIsAtLeast($roles::$editor)) { ?>
                                    <div class="inlineDropDownContainer">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="#/tickets/editMilestone/<?php echo $row->id; ?>" class=''><i class="fa fa-edit"></i> {{ __("links.edit_milestone") }}</a></li>
                                            <li><a href="#/tickets/moveTicket/<?php echo $row->id; ?>" class=""><i class="fa-solid fa-arrow-right-arrow-left"></i> {{ __("links.move_milestone") }}</a></li>
                                            <li><a href="#/tickets/delMilestone/<?php echo $row->id; ?>" class="delete"><i class="fa fa-trash"></i> {{ __("links.delete") }}</a></li>
