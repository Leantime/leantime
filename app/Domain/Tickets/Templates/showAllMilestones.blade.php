...
<div class="maincontent">
    ...
    <div class="maincontentinner">
        ...
        @foreach($allTicketGroups as $group)
            ...
            <x-globals::elements.table :datatable="true" class="tw:w-full tw:overflow-x-auto ticketTable">
                <x-slot:colgroup>
                    <colgroup>
                            ...
                            <td>
                                @if($row['type'] == 'milestone')
                                    <div hx-trigger="load"
                                         hx-target="this"
                                         hx-swap="innerHTML"
                                         hx-get="{{ BASE_URL }}/hx/tickets/milestones/progress?milestoneId={{ $row['id'] }}&noText=true&size=sm"
                                         aria-live="polite">
