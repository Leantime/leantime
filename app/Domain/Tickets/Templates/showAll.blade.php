...
@section('content')
    ...
    <div class="maincontent">
        ...
        <div class="maincontentinner">
            ...
            <div class="row">
                <div class="col-md-4">
                    @php $tpl->dispatchTplEvent('filters.afterLefthandSectionOpen'); @endphp

                    @include('tickets::includes.ticketNewBtn')
                    @include('tickets::includes.ticketFilter')

                    @php $tpl->dispatchTplEvent('filters.beforeLefthandSectionClose'); @endphp
                </div>
                ...
                <div class="col-md-4">
                    <div class="pull-right">
                        ...
                        @php $tpl->dispatchTplEvent('filters.afterRighthandSectionOpen'); @endphp

                        {{--<div id="tableButtons" style="display:inline-block"></div>--}}

                        @php $tpl->dispatchTplEvent('filters.beforeRighthandSectionClose'); @endphp
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() {
            @php $tpl->dispatchTplEvent('scripts.afterOpen'); @endphp
            ...
            @php $tpl->dispatchTplEvent('scripts.beforeClose'); @endphp
