...
<x-globals::layout.page-header icon="view_timeline" subtitle="{!! e(session('currentProjectClient') ?? '' . ' // ' . session('currentProjectName') ?? '') !!}">
    ...
    <h1>
        ...
        <x-globals::actions.dropdown-menu variant="link" trailing-visual="arrow_drop_down" trigger-class="header-title-dropdown" align="end">
            <x-slot:label>
                ...
                <li><a class="wikiModal inlineEdit" href="#/sprints/editSprint/"><x-globals::elements.icon name="add" /> {{ __('links.create_sprint_no_icon') }}</a></li>
