...
<div class="maincontent milestone-review-page" style="padding: 24px 30px;">
...
.milestone-review-page { max-width: 1200px; }
...
.milestone-review-breadcrumb a { color: inherit; text-decoration: none; }
.milestone-review-breadcrumb a:hover { opacity: 1; text-decoration: underline; }
.bc-sep { opacity: .4; }
...
.mrh-meta span { display: flex; align-items: center; gap: 5px; }
...
.ms-badge-done       { background: rgba(92,184,92,.15); color: #3d9140; border: 1px solid rgba(92,184,92,.3); }
.ms-badge-review     { background: rgba(230,126,34,.15); color: #e67e22; border: 1px solid rgba(230,126,34,.3); }
.ms-badge-allDone    { background: rgba(240,173,78,.15); color: #c8860a; border: 1px solid rgba(240,173,78,.3); }
.ms-badge-inprogress { background: rgba(74,158,255,.12); color: var(--accent1,#4a9eff); border: 1px solid rgba(74,158,255,.25); }
...
.mr-section-sub { font-weight: 400; text-transform: none; letter-spacing: 0; opacity: .7; font-size: 12px; }
...
.mr-progress-fill { height: 100%; border-radius: 5px; transition: width .4s ease; }
.fill-done   { background: #5cb85c; }
.fill-review { background: #e67e22; }
.fill-active { background: var(--accent1, #4a9eff); }
.mr-progress-label { font-size: 12px; opacity: .6; }
...
.mr-task-row:last-child td { border-bottom: none; }
.mr-task-row:hover td { background: rgba(0,0,0,.02); }
.mr-task-row.task-done { opacity: .55; }
.mr-task-row.task-blocked td { background: rgba(217,83,79,.04); }

.task-check { text-align: center; width: 36px; }
.task-tick  { color: #5cb85c; font-size: 16px; }
.task-blocked-icon { color: #d9534f; font-size: 15px; }
.task-open-icon    { color: rgba(0,0,0,.25); font-size: 15px; }

.task-link { color: inherit; text-decoration: none; }
.task-link:hover { color: var(--accent1, #4a9eff); text-decoration: underline; }
.task-link-done { text-decoration: line-through; }
...
.task-status-done    { background: rgba(92,184,92,.15); color: #3d9140; }
.task-status-blocked { background: rgba(217,83,79,.15); color: #d9534f; }
.task-status-open    { background: rgba(0,0,0,.07); color: inherit; }

.task-due { font-size: 12px; opacity: .6; white-space: nowrap; }
.task-overdue { color: #d9534f !important; opacity: 1 !important; font-weight: 600; }
...
.mr-action-group { }
.mr-action-hint  { font-size: 12px; opacity: .7; margin-bottom: 8px; line-height: 1.5; }
.mr-action-btn   { font-size: 13px; }
.mr-textarea     {
    width: 100%;
...
.mr-info-list dt { font-weight: 600; opacity: .55; white-space: nowrap; }
.mr-info-list dd { margin: 0; }
...
.mr-input:focus { outline: none; border-color: var(--accent1, #4a9eff); box-shadow: 0 0 0 2px rgba(74,158,255,.15); }

/* Mobile */
@media (max-width: 860px) {
    .milestone-review-grid { grid-template-columns: 1fr; }
    .mr-sidebar { order: -1; }
}
</style>
