...
<div class="pageheader">
    ...
    <div class="pagetitle">
        ...
        <h1>
            <h1><?php echo $tpl->__('headlines.accountSettings'); ?></h1>
        </h1>
    </div>
</div><!--pageheader-->
                            ...
                            <div class="row-fluid">
                                <div class="form-group">
                                    ...
                                    <span class='field span6'>
                                        <input type="text" class="input" name="firstname" id="firstname" <?= $_SESSION['userdata']['isLdap'] ? "disabled='disabled'" : ''; ?> value="<?php $tpl->e($values['firstname']) ?>" /><br />
                                    </span>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class='field span6'>
                                        <input type="text" name="lastname" class="input" id="lastname" <?= $_SESSION['userdata']['isLdap'] ? "disabled='disabled'" : ''; ?> value="<?php $tpl->e($values['lastname']) ?>" /><br />
                                    </span>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class='field span6'>
                                        <input type="text" name="user" class="input" id="user" <?= $_SESSION['userdata']['isLdap'] ? "disabled='disabled'" : ''; ?> value="<?php $tpl->e($values['user']) ?>" /><br />
                                    </span>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class='field span6'>
                                        <input type="text" name="phone" class="input" id="phone" <?= $_SESSION['userdata']['isLdap'] ? "disabled='disabled'" : ''; ?> value="<?php $tpl->e($values['phone']) ?>" /><br />
                                    </span>
                                </div>
                        ...
                        <form method="post">
                            ...
                            <div class="row-fluid">
                                <div class="form-group">
                                    ...
                                    <span class='field span6'>
                                        <input type='password' value="" name="currentPassword" class="input" <?= $_SESSION['userdata']['isLdap'] ? "disabled='disabled'" : ''; ?> id="currentPassword" /><br />
                                    </span>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class='field span6'>
                                        <input type='password' value="" name="newPassword" class="input" <?= $_SESSION['userdata']['isLdap'] ? "disabled='disabled'" : ''; ?> id="newPassword" />
                                ...
                                <div class="form-group">
                                    ...
                                    <span class='field span6'>
                                        <input type="password" value="" name="confirmPassword" class="input" <?= $_SESSION['userdata']['isLdap'] ? "disabled='disabled'" : ''; ?> id="confirmPassword" /><br />
                                        <?php if (!$_SESSION['userdata']['isLdap']) { ?>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="row-fluid">
                                <div class="form-group">
                                    ...
                                    <span class='field span6'>
                                        <input type="checkbox" value="" name="notifications" class="input" id="notifications" <?php if ($values['notifications'] == "1") {
                ...
                <div class="par">
                    ...
                    <div class='fileupload fileupload-new' data-provides='fileupload'>
                        ...
                        <p class='stdformbutton'>
                            ...
                            <input id="picSubmit" type="submit" name="savePic" class="hidden" value="<?php echo $tpl->__('buttons.upload'); ?>" />
                        </p>
                    </div>
                </div>
            </div>
