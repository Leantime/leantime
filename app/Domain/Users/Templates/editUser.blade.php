        ...
        <div class="maincontent">
            <div class="tw:grid tw:grid-cols-[7fr_5fr] tw:gap-6">
                <div>
                    ...
                    <label for="firstname">{{ __('label.firstname') }}</label> <input type="text" name="firstname" id="firstname" value="{{ e($values['firstname']) }}" /><br />

                    <label for="lastname">{{ __('label.lastname') }}</label> <input type="text" name="lastname" id="lastname" value="{{ e($values['lastname']) }}" /><br />
                    ...
                    <select name="client" id="client">
                        ...
                        <label for="user">{{ __('label.email') }}</label> <input type="text" name="user" id="user" value="{{ e($values['user']) }}" /><br />

                        <label for="phone">{{ __('label.phone') }}</label> <input type="text" name="phone" id="phone" value="{{ e($values['phone']) }}" /><br /><br />

                        <h4 class="widgettitle title-light">{{ __('label.employee_information') }}</h4>
                        <label for="jobTitle">{{ __('label.jobTitle') }}</label> <input type="text" name="jobTitle" id="jobTitle" value="{{ e($values['jobTitle']) }}" /><br />

                        <label for="jobLevel">{{ __('label.jobLevel') }}</label> <input type="text" name="jobLevel" id="jobLevel" value="{{ e($values['jobLevel']) }}" /><br />

                        <label for="department">{{ __('label.department') }}</label> <input type="text" name="department" id="department" value="{{ e($values['department']) }}" /><br />
