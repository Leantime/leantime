                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <form class="" method="post" id=""
                                        action="<?= BASE_URL ?>/setting/editCompanySettings#details">
                                        ...
                                        <div class="row" id="telemetryContainer">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <i class="fa fa-question-circle" style="vertical-align: bottom;"
                                                    data-tippy-content="<?= strip_tags($tpl->__('label.telemetry_background')) ?>"></i>
                                ...
                                <div class="col-md-4">
                                                    ...
                                                    <div class='fileupload fileupload-new' data-provides='fileupload'>
                                                        ...
                                                        <div class="input-append">
                                                            ...
                                                            <a href='#' style="margin-left:5px;"
                                                                ...
                                                                onclick="leantime.usersController.clearCroppie()"><?= $tpl->__('buttons.remove') ?></a>
                                                        </div>
                                                        <p class='stdformbutton'>
                                                            <span id="save-logo"
                                                                class="btn btn-primary fileupload-exists ld-ext-right">
                                                                <span
                                                                    onclick="leantime.settingController.saveCroppie()"><?= $tpl->__('buttons.save') ?></span>
                                                                <span class="ld ld-ring ld-spin"> </span>
                                                            </span>

                                                            <input id="picSubmit" type="submit" name="savePic"
                                                                class="hidden"
                                    ...
                                    <a href="<?= BASE_URL ?>/setting/editCompanySettings?resetLogo=1"
                                        class="btn btn-default"><?= $tpl->__('buttons.reset_logo') ?></a>
                                </div>
                            </div>
                        </div>
                            ...
                            <ul class="sortableTicketList">
                                ...
                                <li>
                                    <div class="ticketBox">
                                        ...
                                        <a
                                            href="#/api/apiKey/<?= $apiKey['id'] ?>"><strong><?= $apiKey['firstname'] ?></strong></a><br />
                                        lt_<?= $apiKey['username'] ?>***
                                        | <?= $tpl->__('labels.created_on') ?>: <?= format($apiKey['createdOn'])->date() ?>
                                        | <?= $tpl->__('labels.last_used') ?>: <?= format($apiKey['lastlogin'])->date() ?>
