...
<div class="maincontent">
    ...
    <div class="maincontentinner">
        <div class="row">
            <div class="col-md-12">
                <x-global::content.tabs name="companyTabs" variant="bordered" size="md" class="mb-2">
                    <x-slot:headings class="col-md-4">
                        <x-global::content.tabs.heading name="details"><span class="fa fa-building"></span> &nbsp {{ __("tabs.details") }}</x-global::content.tabs.heading>
                        <x-global::content.tabs.heading name="apiKeys"><i class="fa-solid fa-key"></i> &nbsp {{ __("tabs.apiKeys") }}</x-global::content.tabs.heading>
                    </x-slot:headings>

                    <x-slot:contents>
                        <x-global::content.tabs.content name="details" ariaLabel="Details" classExtra="p-sm" :checked="true">
                            <div class="row">
                                <div class="col-md-8">
                        ...
                        <x-global::content.tabs.content name="apiKeys" ariaLabel="API Keys" classExtra="p-sm">
                            <x-global::forms.button tag="a" href="#/api/newApiKey" scale="sm">
                                Generate API Key
                            </x-global::forms.button>
                            <br /> <br />
