        ...
        <div class="row">
            <div class="col-md-9">
                <div class="maincontentinner center">
                    ...
                    <form method="post"
                        action="<?= BASE_URL ?>/connector/integration/?provider=<?= $provider->id ?>&step=parse<?= $urlAppend ?>">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                        <x-global::forms.select :name="'field_' . md5($entity)" class="form-control">
                                            @foreach ($leantimeFields as $key2 => $fields)
                                                <x-global::forms.select.select-option :value="$entity . '|' . $key2" :selected="$entity == $fields['name']">
                                                    {{ $fields['name'] }}
