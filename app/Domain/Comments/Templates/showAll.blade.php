...
@section('content')
    ...
    <h4 class="widgettitle title-light"><span class="fa fa-comments"></span>{{ __('subtitles.discussion') }}
    </h4>

    <form method="post" accept-charset="utf-8" action="<?php echo $formUrl; ?>" id="commentForm">
        <a href="javascript:void(0);" onclick="toggleCommentBoxes(0)" style="display:none;" id="mainToggler"><span
        ...
        <div id="comment0" class="commentBox">
            ...
            <br />
            <x-global::forms.button type="submit" name="comment" class="btn btn-default btn-success"
        ...
        <div id="comments">
            <div>
                ...
                <div style="display:block; padding:10px; margin-top:10px; border-bottom:1px solid #f0f0f0;">
                    ...
                    <div class="right"><?php printf($tpl->__('text.written_on'), format($row['date'])->date(), format($row['date'])->time()); ?></div>
                    <strong>
                    ...
                    <div style="padding-left:60px">
                        <a href="javascript:void(0);" class="replyButton" onclick="toggleCommentBoxes(<?php echo $row['id']; ?>)">
    ...
    <script type='text/javascript'>
        function toggleCommentBoxes(id) {
            ...
            jQuery('.commentBox').hide('fast', function() {
                ...
                jQuery('#comment' + id + '').prepend(
                    '<textarea rows="5" cols="75" name="text" class="tinymceSimple"></textarea>');
