        ...
        <div id="sortableCanvasKanban" class="sortableTicketList disabled">
            <div class="row-fluid"><div class="column" style="width: 100%; min-width: calc(4 * 250px);">
                ...
                <div class="row canvas-row">
                    <div class="column" style="width:100%">
                        <h4 class="widgettitle title-primary center canvas-title-only">
                            <i class="fas fa-bullseye"></i> {!! __('box.em.header.goal') !!}
                        </h4>
                    </div>
                </div>
                ...
                <div class="row canvas-row">
                    <div class="column" style="width: 100%">
                        <h4 class="widgettitle title-primary center canvas-title-only">
                            <i class="fas fa-heart"></i> {!! __('box.em.header.empathy') !!}
                        </h4>
                    </div>
                </div>
                ...
                <div class="row canvas-row">
                    <div class="column" style="width: 100%">
                        <h4 class="widgettitle title-primary center canvas-title-only">
                            <i class="fas fa-7"></i> {!! __('box.em.header.think_feel') !!}
                        </h4>
                    </div>
                </div>
