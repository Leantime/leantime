leantime.timesheetsController = (function () {
    ...
    var initMyTimesheetsTable = function () {
        var tableEl = document.querySelector("#myTimesheetsTable");
        if (!tableEl) return;

        var myTimesheets = jQuery("#myTimesheetsTable").DataTable({
            "language": {
                "decimal":        leantime.i18n.__("datatables.decimal"),
                "emptyTable":     leantime.i18n.__("datatables.emptyTable"),
                "info":           leantime.i18n.__("datatables.info"),
        ...
        var buttons = new jQuery.fn.dataTable.Buttons(myTimesheets, {
            buttons: [
                {
                    extend: 'csvHtml5',
                    title: leantime.i18n.__("label.filename_fileexport"),
        ...
        jQuery('#myTimesheetsTable').on('column-visibility.dt', function (e, settings, column, state) {
            myTimesheets.draw(false);
        });
    };
    ...
    return {
        ...
        initMyTimesheetsTable:initMyTimesheetsTable,
    };
})();
