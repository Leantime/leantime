@if ($login::userIsAtLeast(\Leantime\Domain\Auth\Models\Roles::$editor, true))
    ...
    <li class="timerHeadMenu dropdown"
        id="timerHeadMenu"
        hx-get="{{ BASE_URL }}/timesheets/stopwatch/get-status"
        hx-trigger="timerUpdate from:body{{ $onTheClock !== false ? ', every 60s' : '' }}"
        hx-swap="outerHTML"
        aria-live="assertive">
    ...
    @if ($onTheClock !== false)
        <a href="javascript:void(0)"
           ...
           data-toggle="dropdown">
            {!! sprintf(__('text.timer_on_todo'), $onTheClock['totalTime'], substr($onTheClock['headline'], 0, 10)) !!}
        </a>
