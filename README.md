...
| -------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------- | ------------------------------------------------------------------------ |
| Task management via<br>kanban boards, table, list and calendar views | Define and strategize on projects using<br>various boards such as SWOT, Lean Canvas, Business Model Canvas, Empathy Maps & more | Wikis / Docs                            | Easy installation                                                        |
| Unlimited subtasks and dependencies                                  | Goal & metrics tracking                                                                                                         | Idea Boards                             | Multiple user roles                                                      |
| Milestone management                                                 | Project Dashboards and Reports                                                                                                  | Retrospectives                          | Per project permission management                                        |
| Sprint Management                                                    |                                                                                                                                 | File Storage via S3 or local filesystem | Two factor authentication                                                |
| Timetracking & timesheets                                            |                                                                                                                                 | Screen & webcam recording               | LDAP, OIDC integration                                                   |
|                                                                      |                                                                                                                                 | Comments/Discussions on everything      | Integration with mattermost, slack, discord and zulip (more coming soon) |
