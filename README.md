...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| \* Task management using kanban boards, table, list and calendar views<br>\* Subtask management & dependencies<br>\* Sprint Management<br>\* Milestone management<br>\* Timesheet management + time tracking on tasks | \* Project dashboards and project updates<br>\* Project reports<br>\* Portfolio overview with project status<br>\* Various research and strategy boards such as SWOT, Lean Canvas, Business Model Canvas, Empathy Maps & more<br>\* Manage goals & metrics | \* Wikis (Docs) with the ability to embed documents<br>\* File storage with AWS S3 or local file system<br>\* Screen and webcam recording<br>\* Comments / Discussion<br>\* Retrospectives<br>\* Idea boards & idea kanban boards | \* Multiple user roles<br>\* Two-Factor Authentication<br>\* LDAP, OIDC integration<br>\* Integrations with Mattermost, Slack, Zulip, Discord<br>\* Integrations with Mattermost, Slack, Zulip, Discord<br>\* Adjust color scheme and logo<br>\* Easy installation<br>\* Integrations with Mattermost, Slack, Zulip, Discord<br>\* Available in 19 languages |
