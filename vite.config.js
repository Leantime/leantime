    ...
    plugins: [
        ...
        laravel({
            ...
            input: [
                ...
                'public/assets/css/entries/editor.css',
                ...
                'public/assets/js/entries/entry-app.js',
                'public/assets/js/entries/entry-footer.js',
                'public/assets/js/entries/entry-lottieplayer.js',
            ],
            refresh: true,
        }),
