...
return (self["webpackChunkleantime"] = self["webpackChunkleantime"] || []).push([["/js/Domain/Dbmcanvas/Js/dbmCanvasController"],{

/***/ "./app/Domain/Dbmcanvas/Js/dbmCanvasController.js":
/*!********************************************************!*\
  !*** ./app/Domain/Dbmcanvas/Js/dbmCanvasController.js ***!
  \********************************************************/
...
var setRowHeights = function setRowHeights() {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#secondRowTop div.contentInner").each(function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).height() > secondRowHeightTop) {
      secondRowHeightTop = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).height() + 50;
    }
  });
  var secondRowHeightBottom = secondRowHeight * 0.5;
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#secondRowBottom div.contentInner").each(function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).height() > secondRowHeightBottom) {
      secondRowHeightBottom = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).height() + 50;
    }
  });
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#secondRowTop .column .contentInner").css("height", secondRowHeightTop);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#secondRowBottom .column .contentInner").css("height", secondRowHeightBottom);
...
/******/ __webpack_require__.O(0, ["js/vendor"], () => (__webpack_exec__("./app/Domain/Dbmcanvas/Js/dbmCanvasController.js")));
