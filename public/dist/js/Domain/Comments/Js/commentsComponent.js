...
return (self["webpackChunkleantime"] = self["webpackChunkleantime"] || []).push([["/js/Domain/Comments/Js/commentsComponent"],{

/***/ "./app/Domain/Comments/Js/commentsComponent.js":
/*!*****************************************************!*\
  !*** ./app/Domain/Comments/Js/commentsComponent.js ***!
  \*****************************************************/
...
var toggleCommentBoxes = function toggleCommentBoxes(parentId, formHash, commentId) {
  var editComment = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  var isReply = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
  console.log("commentsBoxes.js updated");
  resetForm(parentId, formHash);
  if (parseInt(parentId, 10) === 0) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.mainToggler-' + formHash).hide();
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.mainToggler-' + formHash).show();
  }
  var content = "";
  if (editComment) {
    content = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#commentText-" + formHash + "-" + commentId).html();

    // Top level comment edit
    if (parentId == commentId) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#commentReplyBox-' + formHash + '-' + parentId + ' > .commentImage').hide();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#comment-' + formHash + '-' + parentId + ' > .commentMain > .replies > form').insertBefore(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#comment-' + formHash + '-' + parentId + ' .replies > div:first-child'));
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#comment-' + formHash + '-' + commentId + ' > .commentImage').hide();
    }
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#comment-' + formHash + '-' + commentId + ' > .commentMain > .commentContent').hide();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#comment-' + formHash + '-' + commentId + ' > .commentMain > .commentLinks').hide();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#edit-comment-' + formHash + '-' + parentId).val(commentId);
  }

  // Remove any existing textareas
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.commentBox-' + formHash + ' textarea').remove();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#editor-' + formHash + '-' + parentId).remove();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.commentBox-' + formHash).hide();

  // Add the textarea for the current comment
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#commentReplyBox-' + formHash + '-' + parentId + ' .commentReply').prepend('<textarea rows="5" cols="75" name="text" id="editor-' + formHash + '-' + parentId + '" class="tinymceSimple">' + content + '</textarea>');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#commentReplyBox-' + formHash + '-' + parentId).removeClass('hidden').show();
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#father-' + formHash).val(parentId);

  // Scroll into view and focus the editor
  setTimeout(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#commentReplyBox-' + formHash + '-' + parentId)[0].scrollIntoView();
    tinyMCE.get('editor-' + formHash + '-' + parentId).focus();
  }, 75);
};
var resetForm = function resetForm(id, formHash) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.mainToggler-' + formHash).show();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#comments-' + formHash + ' .commentImage').show();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#comments-' + formHash + ' .commentContent').show();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#comments-' + formHash + ' .commentLinks').show();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.commentReplyBox-' + formHash + '').hide();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.commentReplyBox-' + formHash + ' textarea').each(function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).tinymce()) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).tinymce().remove();
    }
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.commentReplyBox-' + formHash + ' textarea').remove();
};
...
/******/ __webpack_require__.O(0, ["js/vendor"], () => (__webpack_exec__("./app/Domain/Comments/Js/commentsComponent.js")));
