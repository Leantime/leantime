            ...
            */
            ...
            function Bar(gt, task) {
                ...
                function draw_bar() {
                    ...
                    self.$bar = gt.canvas.rect(self.x, self.y, self.width, self.height, self.corner_radius, self.corner_radius).addClass('bar').attr('fill', self.color).appendTo(self.bar_group);
                    if (self.invalid) {
