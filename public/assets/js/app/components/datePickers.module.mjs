...
import {getFormatFromSettings} from "../support/dateHelper.module.mjs";
...
let dateTimePickerConfig = {
    ...
    onChange: function(selectedDates, dateStr, instance) {
        ...
        jQuery(instance.element).closest('.date-dropdown').find(".dateField").text(formattedDate);
        ...
        if(instance.config.enableTime) {
            ...
            jQuery(instance.element).closest('.date-dropdown').find(".timeField").text(formattedTime);
        }
    }
};
